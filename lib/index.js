...
function mapInputKeysMultiple (inputs) {
  return {
    ...
    projectV2: inputs['project-v2-path'],
    column: inputs.column,
    milestone: inputs.milestone,
    pinned: inputs.pinned,
    closePrevious: inputs['close-previous'],
    skipOnPrevious: inputs['skip-on-previous'],
    atDatetimeISO: inputs['at-datetime-iso'] || undefined,
    rotateAssignees: inputs['rotate-assignees'],
    linkedComments: inputs['linked-comments'],
    linkedCommentsNewIssueText: inputs['linked-comments-new-issue-text'],
    linkedCommentsPreviousIssueText: inputs['linked-comments-previous-issue-text']
  };
}
